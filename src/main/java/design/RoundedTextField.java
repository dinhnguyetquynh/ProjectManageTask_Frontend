...
public class RoundedTextField extends JTextField {
    ...
    public RoundedTextField(int columns, String placeholder, int width, int height) {
        super(columns);
        this.placeholder = placeholder;
        this.width = width;
        this.height = height;
    ...
    public RoundedTextField(int columns, String placeholder, int width, int height, int border) {
        super(columns);
        this.placeholder = placeholder;
        this.width = width;
        this.height = height;
    ...
    public RoundedTextField(int columns, String placeholder, int border) {
        super(columns);
        this.placeholder = placeholder;
        this.border = border;
        setOpaque(false);
