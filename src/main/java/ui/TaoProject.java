...
public class TaoProject extends JFrame {
	...
	public TaoProject() {
		...
		JLabel lblTitle;
		b1.add(lblTitle = new JLabel("Tạo dự án mới"));
		...
		model.addElement(new CheckListItem("user 5"));
		model.addElement(new CheckListItem("user 6"));
		model.addElement(new CheckListItem("user 7"));
		model.addElement(new CheckListItem("user 8"));
		...
		b7.add(btnTaoDuAn = new JButton("Tạo"));
		btnTaoDuAn.setBackground(btnColor);
		btnTaoDuAn.setMaximumSize(new Dimension(195, 40));
